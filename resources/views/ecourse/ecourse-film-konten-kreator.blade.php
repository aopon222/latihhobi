    ...
    <section style="background:#04a6d6; padding:28px 0 56px;">
        <div class="container">
            <div class="grid">
                <article class="card">
                    <div class="card-wrap">
                        <img class="thumb" src="{{ asset('images/FILM 1.svg') }}" alt="Level 1">
                        <div class="lock">🔖</div>
                    </div>
                    <div class="body">
                        <h3 class="title">Kelas Film & Content Creator 1</h3>
                        <p class="byline">By Latihhobi In Film and Content Creator</p>
                    </div>
                    <div class="footer">
                        <div>
                ...
                <article class="card">
                    <div class="card-wrap">
                        <img class="thumb" src="{{ asset('images/FILM 2.svg') }}" alt="Level 2">
                        <div class="lock">🔖</div>
                    </div>
                    <div class="body">
                        <h3 class="title">Kelas Film & Content Creator 2</h3>
                        <p class="byline">By Latihhobi In Film and Content Creator</p>
                    </div>
                    <div class="footer">
                        <div>
                ...
                <article class="card protected">
                    <div class="card-wrap">
                        <img class="thumb" src="{{ asset('images/FILM 3.svg') }}" alt="Level 3">
                        <div class="lock">🔖</div>
                    </div>
                    <div class="body">
                ...
                <article class="card protected">
                    <div class="card-wrap">
                        <img class="thumb" src="{{ asset('images/FILM 4.svg') }}" alt="Level 4">
                        <div class="lock">🔖</div>
                    </div>
                    <div class="body">
                ...
                <article class="card protected">
                    <div class="card-wrap">
                        <img class="thumb" src="{{ asset('images/FILM 5.svg') }}" alt="Level 5">
                        <div class="lock">🔖</div>
                    </div>
                    <div class="body">
