    ...
    <section class="film-page">
        ...
        <div class="courses-container">
            ...
            @php
                ...
                $coursesToShow = $filmCourses ?? $courses ?? collect();
            @endphp
                    ...
                    @foreach ($coursesToShow as $course)
                        <div class="film-card">
                            ...
                            <div class="film-info">
                                ...
                                @if ($course->course_by)
                                    <p class="film-instructor">{{ $course->course_by }}</p>
                                @endif
            ...
            @else
                <div class="no-courses">
                    ...
                    <h3>Belum Ada Kursus Film & Konten Kreator</h3>
                    <p>Kursus film dan konten kreator akan segera hadir. Pantau terus untuk update terbaru!</p>
                </div>
            @endif
        </div>
    </section>
