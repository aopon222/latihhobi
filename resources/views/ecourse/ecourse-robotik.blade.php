    ...
    <section style="background:#04a6d6; padding:28px 0 56px;">
        <div class="container">
            <div class="grid">
                <article class="card">
                    <div class="card-wrap">
                        <img class="thumb" src="{{ asset('images/ROBOTIK 1.svg') }}" alt="Level 1">
                        <div class="lock">🔖</div>
                    </div>
                    <div class="body">
                        <h3 class="title">Kelas ROBOT ATHURO Level 1</h3>
                ...
                <article class="card">
                    <div class="card-wrap">
                        <img class="thumb" src="{{ asset('images/ROBOTIK 2.svg') }}" alt="Level 2">
                        <div class="lock">🔖</div>
                    </div>
                    <div class="body">
                        <h3 class="title">Kelas ROBOT   ROBOFAN Level 2</h3>
                        <p class="byline">By Latihhobi In Robotik</p>
                    </div>
                    <div class="footer">
                        <div>
                ...
                <article class="card protected">
                    <div class="card-wrap">
                        <img class="thumb" src="{{ asset('images/ROBOTIK 3.svg') }}" alt="Level 3">
                        <div class="lock">🔖</div>
                    </div>
                    <div class="body">
                ...
                <article class="card protected">
                    <div class="card-wrap">
                        <img class="thumb" src="{{ asset('images/ROBOTIK 4.svg') }}" alt="Level 4">
                        <div class="lock">🔖</div>
                    </div>
                    <div class="body">
                ...
                <article class="card protected">
                    <div class="card-wrap">
                        <img class="thumb" src="{{ asset('images/ROBOTIK 5.svg') }}" alt="Level 5">
                        <div class="lock">🔖</div>
                    </div>
                    <div class="body">
