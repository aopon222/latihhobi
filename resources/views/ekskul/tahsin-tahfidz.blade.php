...
@section('title', 'Ekskul Tahsin & Tahfidz - LatihHobi')
...
<div class="ekskul-hero">
    <div class="ekskul-hero-content">
        <h1>EKSKUL TAHSIN & TAHFIDZ</h1>
        <p>
            "Pelajari bacaan dan hafalan Al-Quran dengan baik!"
        </p>
    </div>
</div>
...
<div class="ekskul-content">
    <div class="ekskul-intro">
        <h2>📖 Ekskul Tahsin & Tahfidz</h2>
        <p>
            Ekskul Tahsin & Tahfidz mengajarkan siswa cara membaca Al-Quran dengan tartil (tahsin) dan menghafal ayat-ayat Al-Quran (tahfidz). Siswa akan meningkatkan kemampuan agama dan spiritual.
        </p>
    </div>
</div>
@endsection
