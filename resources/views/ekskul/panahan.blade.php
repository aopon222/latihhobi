...
<div class="ekskul-hero">
    <div class="ekskul-hero-content">
        ...
        <p>
            "Tingkatkan ketepatan dan fokus melalui olahraga panahan!"
        </p>
    </div>
</div>
...
<div class="ekskul-content">
    <div class="ekskul-intro">
        <h2>🏹 Ekskul Panahan</h2>
        <p>
            Ekskul Panahan melatih siswa dalam teknik memanah yang benar, meningkatkan konsentrasi, kekuatan fisik, dan disiplin. Cocok untuk siswa yang suka olahraga dan tantangan.
        </p>
    </div>
</div>
@endsection
