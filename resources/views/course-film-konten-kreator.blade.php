    ...
    <section style="background:#04a6d6; padding:28px 0 56px;">
        <div class="container">
            <div class="grid">
                <article class="card">
                    <div class="card-wrap">
                        <img class="thumb" src="{{ asset('images/placeholder-film.svg') }}" alt="Level 1">
                        <div class="lock">🔖</div>
                    </div>
                    <div class="body">
                ...
                <article class="card">
                    <div class="card-wrap">
                        <img class="thumb" src="{{ asset('images/placeholder-film.svg') }}" alt="Level 2">
                        <div class="lock">🔖</div>
                    </div>
                    <div class="body">
                ...
                <article class="card protected">
                    <div class="card-wrap">
                        <img class="thumb" src="{{ asset('images/placeholder-film.svg') }}" alt="Level 3">
                        <div class="lock">🔖</div>
                    </div>
                    <div class="body">
                ...
                <article class="card protected">
                    <div class="card-wrap">
                        <img class="thumb" src="{{ asset('images/placeholder-film.svg') }}" alt="Level 4">
                        <div class="lock">🔖</div>
                    </div>
                    <div class="body">
                ...
                <article class="card protected">
                    <div class="card-wrap">
                        <img class="thumb" src="{{ asset('images/placeholder-film.svg') }}" alt="Level 5">
                        <div class="lock">🔖</div>
                    </div>
                    <div class="body">
