...
@section('content')
    <section class="hero" style="background: linear-gradient(135deg, #00a8e6 0%, #ff6b35 100%); color: white; padding: 4rem 5% 3rem; text-align: center; border-radius: 15px; margin-top: 0; position: relative; overflow: hidden;">
